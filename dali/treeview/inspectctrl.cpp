...
#define STRCAT(dest, destSz, src) {size32_t l = strlen32(src); if(destSz > l) { strcat(dest, src); destSz -= l; } }
...
{
    return SCAST_IF_x64(LONG, ::DefWindowProc(hWnd, msg, wParam, lParam));
}
